...
const dict = {
  ...
  courses: {
    ...
    continueLesson: { ar: 'أكمل الدرس', en: 'Continue' },
    completedLessons: { ar: 'درس مكتمل', en: 'lessons completed' },
    markComplete: { ar: 'إكمال الدرس', en: 'Mark as Complete' },
    completed: { ar: 'مكتمل', en: 'Completed' },
    lessonNotes: { ar: 'ملاحظات الدرس', en: 'Lesson Notes' },
    lessonResources: { ar: 'مصادر الدرس', en: 'Lesson Resources' },
    nextLesson: { ar: 'الدرس التالي', en: 'Next Lesson' },
    previousLesson: { ar: 'الدرس السابق', en: 'Previous Lesson' },
    enrollFirst: { ar: 'يجب التسجيل في الدورة أولًا', en: 'You must enroll in this course first' },
    startCourse: { ar: 'ابدأ الدورة', en: 'Start Course' },
  },
  account: {
    ...
    registerBtn: { ar: 'إنشاء حساب', en: 'Sign Up' },
