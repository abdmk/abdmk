...
SERVICES = [
    ...
    ("arabic-typography", "التايبوغرافي العربي", "Arabic Typography",
     "ضبط النص العربي: الاختيار، التنسيق، الشبكة، والعلاقة بين العربي واللاتيني.",
     "Setting Arabic well: selection, composition, grid, and how Arabic and Latin sit together.",
     [("نظام تايبوغرافي", "Type system"),
    ...
    ("arabic-calligraphy", "الخط العربي", "Arabic Calligraphy",
     "أعمال خط يدوي ورقمنة للأعمال الخطية للاستخدام في الهويات والمطبوعات.",
     "Hand-lettered Arabic and digitised calligraphy for identities and print.",
     [("عمل خطي أصلي", "Original lettering"),
      ("رقمنة ومعالجة", "Digitisation & clean-up"),
      ("ملفات متجهة", "Vector files")], False),
    ("art-direction", "الإدارة الفنية", "Art Direction",
     "توجيه بصري لحملة أو منتج أو إصدار — من المزاج إلى التنفيذ.",
     "Visual direction for a campaign, product or issue — from mood to final execution.",
     [("لوحة اتجاه بصري", "Art direction deck"),
      ("إشراف على التصوير", "Shoot supervision"),
      ("مراجعة التنفيذ", "Execution review")], True),
    ("motion-design", "الموشن", "Motion Design",
    ...
    ("editorial-design", "التصميم التحريري", "Editorial Design",
     "كتب ومجلات وتقارير: شبكة، تسلسل، وإيقاع صفحات يخدم القراءة.",
     "Books, magazines and reports: grid, sequence and a page rhythm that serves reading.",
     [("شبكة وأنماط صفحات", "Grid & page styles"),
    ...
    ("packaging-design", "تصميم التغليف", "Packaging Design",
     "تغليف يقرأ على الرف: تسلسل معلومات واضح وحضور بصري قوي.",
     "Packaging that reads on the shelf: a clear information hierarchy and real presence.",
     [("تصميم العبوة", "Structural & surface design"),
...
for i, (slug, nar, nen, ctype, dar, den, rar, ren, par, pen, feat, exp) in enumerate(COMPANIES):
    companies.append({
        ...
        "period": L(par, pen),
        "type": ctype,
        "services": ["brand-identity", "art-direction"] if ctype in ("studio", "agency") else ["brand-identity"],
...
PROJECTS = [
    dict(slug="mizan-identity", ar="هوية ميزان", en="Mizan Identity",
         ...
         svcs=["brand-identity", "arabic-typography", "art-direction"],
    ...
    dict(slug="sard-typeface-campaign", ar="حملة إطلاق خط سرد", en="Sard Typeface Launch",
         ...
         svcs=["font-design", "art-direction", "arabic-typography"],
    ...
    dict(slug="beirut-book-fair", ar="معرض بيروت للكتاب", en="Beirut Book Fair",
         ...
         svcs=["brand-identity", "art-direction", "editorial-design"],
    ...
    dict(slug="qamar-packaging", ar="تغليف قمر", en="Qamar Packaging",
         ...
         svcs=["packaging-design", "brand-identity"],
    ...
    dict(slug="nahda-editorial", ar="سلسلة النهضة", en="Nahda Editorial Series",
         ...
         svcs=["editorial-design", "arabic-typography"],
    ...
    dict(slug="halaqa-social", ar="حلقة — سوشيال", en="Halaqa Social System",
         ...
         svcs=["social-media-design", "art-direction"],
    ...
    dict(slug="tariq-wayfinding", ar="نظام إرشاد طريق", en="Tariq Wayfinding",
         ...
         svcs=["arabic-typography", "art-direction"],
    ...
    dict(slug="aswat-motion", ar="أصوات — هوية متحركة", en="Aswat Motion Identity",
         ...
         svcs=["motion-design", "art-direction"],
    ...
    dict(slug="khatt-poster-series", ar="سلسلة ملصقات خط", en="Khatt Poster Series",
         ...
         svcs=["arabic-calligraphy", "art-direction"],
...
for i, (slug, kind, tar, ten, dar, den, date, end, durar, duren, locar, locen, mode, par, pen, seats, feat) in enumerate(WORKSHOPS):
    workshops.append({
        ...
        "relatedServices": ["font-design", "arabic-typography"] if "type" in slug else ["brand-identity"],
        "featured": feat,
    })
